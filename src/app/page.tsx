          ...
          <div className="eco-hero-card" style={{
            ...
            <div style={{ padding: "0.8rem 1rem", display: "flex", flexDirection: "column", justifyContent: "space-between", flex: 1, minWidth: 0, gap: "0.55rem", textAlign: "left" }}>
              ...
              <div style={{ borderTop: "1px solid var(--card-border)", paddingTop: "0.5rem", display: "flex", alignItems: "center", gap: 6 }}>
                <svg width="16" height="14" viewBox="0 0 111 96" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path d="M108.53 75.69L90.91 94.69C90.53 95.1 90.06 95.44 89.55 95.67C89.03 95.89 88.47 96.01 87.91 96.01H3.24C2.85 96.01 2.46 95.9 2.13 95.69C1.79 95.48 1.52 95.18 1.35 94.82C1.18 94.46 1.11 94.07 1.15 93.67C1.2 93.28 1.35 92.91 1.59 92.6L19.21 73.6C19.59 73.18 20.06 72.85 20.58 72.62C21.1 72.39 21.66 72.27 22.23 72.27H106.89C107.28 72.27 107.67 72.38 108 72.59C108.34 72.8 108.61 73.1 108.78 73.46C108.95 73.82 109.02 74.21 108.98 74.61C108.93 75 108.78 75.37 108.54 75.68L108.53 75.69Z" fill="url(#sl0)"/>
                  <path d="M108.53 0.32L90.91 19.32C90.53 19.73 90.06 20.07 89.55 20.3C89.03 20.52 88.47 20.64 87.91 20.64H3.24C2.85 20.64 2.46 20.53 2.13 20.32C1.79 20.11 1.52 19.81 1.35 19.45C1.18 19.09 1.11 18.7 1.15 18.3C1.2 17.91 1.35 17.54 1.59 17.23L19.21 -1.77C19.59 -2.19 20.06 -2.52 20.58 -2.75C21.1 -2.98 21.66 -3.1 22.23 -3.1H106.89C107.28 -3.1 107.67 -2.99 108 -2.78C108.34 -2.57 108.61 -2.27 108.78 -1.91C108.95 -1.55 109.02 -1.16 108.98 -0.76C108.93 -0.37 108.78 0 108.54 0.31L108.53 0.32Z" fill="url(#sl1)"/>
                  <path d="M108.53 37.69L90.91 56.69C90.53 57.1 90.06 57.44 89.55 57.67C89.03 57.89 88.47 58.01 87.91 58.01H3.24C2.85 58.01 2.46 57.9 2.13 57.69C1.79 57.48 1.52 57.18 1.35 56.82C1.18 56.46 1.11 56.07 1.15 55.67C1.2 55.28 1.35 54.91 1.59 54.6L19.21 35.6C19.59 35.18 20.06 34.85 20.58 34.62C21.1 34.39 21.66 34.27 22.23 34.27H106.89C107.28 34.27 107.67 34.38 108 34.59C108.34 34.8 108.61 35.1 108.78 35.46C108.95 35.82 109.02 36.21 108.98 36.61C108.93 37 108.78 37.37 108.54 37.68L108.53 37.69Z" fill="url(#sl2)"/>
                  <defs>
                    <linearGradient id="sl0" x1="10.51" y1="97.5" x2="99.86" y2="69.5" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#9945FF"/><stop offset="0.42" stopColor="#6377D6"/><stop offset="1" stopColor="#14F195"/>
                    </linearGradient>
                    <linearGradient id="sl1" x1="10.51" y1="97.5" x2="99.86" y2="69.5" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#9945FF"/><stop offset="0.42" stopColor="#6377D6"/><stop offset="1" stopColor="#14F195"/>
                    </linearGradient>
                    <linearGradient id="sl2" x1="10.51" y1="97.5" x2="99.86" y2="69.5" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#9945FF"/><stop offset="0.42" stopColor="#6377D6"/><stop offset="1" stopColor="#14F195"/>
                    </linearGradient>
                  </defs>
                </svg>
                <span style={{ fontSize: "9.5px", color: "var(--text-muted)", fontWeight: 500, letterSpacing: "0.01em" }}>Powered by Solana</span>
              </div>
            </div>
          </div>
        </div>
