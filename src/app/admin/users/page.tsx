            ...
            <tbody>
              {users.map((user) => (
                <tr key={user.id} style={{ borderTop: "1px solid var(--card-border)" }}>
                  ...
                  <td style={{ padding: "1.25rem 1.5rem" }}>
                    {(user.role === "OWNER" || user.twitterHandle === OWNER_HANDLE) ? (
                      ...
                      <span style={{ background: "rgba(99,102,241,0.08)", color: "#6366f1", padding: "3px 10px", borderRadius: 6, fontSize: "0.65rem", fontWeight: 700, border: "1px solid rgba(99,102,241,0.2)" }}>SUPPORT</span>
                    ) : (
                  ...
                  <td style={{ padding: "1.25rem 1.5rem", textAlign: "right" }}>
                    <AdminUserActions userId={user.id} role={user.role} isOG={user.isOG} canManage={owner} isOwner={owner} />
                  </td>
                </tr>
              ))}
            </tbody>
