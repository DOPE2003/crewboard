...
export default async function AdminDashboardPage() {
  ...
  const [
    ...
    isOwner || isAdmin ? db.job.count({ where: { status: "open" } }) : Promise.resolve(0),
    // Funnel
  ...
  const allSections = [
    ...
    },
    {
      ...
      label: "Freelancer Levels",
      desc: "Level 1–5 rankings based on profile, gigs, orders, and ratings",
      count: totalUsers, countLabel: "users", color: "#f59e0b",
    ...
    },
    {
      ...
      href: "/admin/jobs",
      label: "Jobs",
      desc: "Close, reopen, or delete any job posting platform-wide",
      count: openJobs, countLabel: "open", color: "#f59e0b",
