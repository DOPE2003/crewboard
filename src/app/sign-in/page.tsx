  ...
  return (
    <>
      ...
      <div style={{ flex: 1, overflowY: "auto" }}>
        <div style={{ minHeight: "100%", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px 0" }}>
          <div style={{ width: "100%", maxWidth: 376, padding: "0 44px" }}>
            ...
            <p style={{ fontSize: 14, color: "#64748b", margin: "0 0 24px", lineHeight: 1.55, fontWeight: 400 }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 11 }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  required style={{ ...field, paddingRight: 44 }}
                />
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 1 }}>
                <label style={{ display: "flex", alignItems: "center", gap: 7, cursor: "pointer", fontSize: 13.5, color: "#475569", userSelect: "none" }}>
                  <input
                    type="checkbox" checked={remember} onChange={e => setRemember(e.target.checked)}
                    style={{ width: 15, height: 15, accentColor: "#14B8A6", cursor: "pointer", borderRadius: 4 }}
                  />
                  Remember me
                </label>
                <Link href="/forgot-password" style={{ fontSize: 13.5, color: "#14B8A6", textDecoration: "none", fontWeight: 500, letterSpacing: "-0.01em" }}>
                  Forgot password?
                </Link>
              </div>
            ...
            {/* Terms */}
            <p style={{ fontSize: 11.5, color: "#94a3b8", textAlign: "center", marginTop: 16, lineHeight: 1.65 }}>
