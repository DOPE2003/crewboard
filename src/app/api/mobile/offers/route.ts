      ...
      type !== "received"
        ? db.offer.findMany({
            ...
            include: {
              ...
              order:    { select: { id: true, status: true, escrowAddress: true, deliveryNote: true, deliveryFiles: true, deliverySubmittedAt: true, deliveryHistory: true, revisionRequests: true, revisionCount: true } },
            },
          })
        : [],
      type !== "sent"
