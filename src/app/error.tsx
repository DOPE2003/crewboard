  ...
  return (
    <main className="page" style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "60vh" }}>
      <div style={{ textAlign: "center", maxWidth: 420, padding: "2rem 1.5rem" }}>
        <div style={{ fontFamily: "Space Mono, monospace", fontSize: "0.6rem", letterSpacing: "0.14em", textTransform: "uppercase", color: "#94a3b8", marginBottom: 12 }}>
          Something went wrong
        </div>
        <h2 style={{ fontFamily: "Rajdhani, sans-serif", fontWeight: 700, fontSize: "1.5rem", color: "#0f172a", margin: "0 0 0.75rem" }}>
          Unexpected Error
        </h2>
        <p style={{ fontFamily: "Outfit, sans-serif", fontSize: "0.85rem", color: "rgba(0,0,0,0.5)", marginBottom: "1.5rem", lineHeight: 1.6 }}>
