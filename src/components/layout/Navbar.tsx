      ...
      <div className="cb-cat-strip" style={{
        ...
        <div style={{
          ...
          <div style={{ flex: 1, display: "flex", justifyContent: "flex-start" }}>
            <Link href="/" className="cb-cat-link cb-intent-link" style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "11px 14px", fontSize: 12, fontWeight: 500, color: "var(--text-muted, #6b7280)", textDecoration: "none", whiteSpace: "nowrap", borderBottom: "2px solid transparent", transition: "color 0.15s, border-color 0.15s", flexShrink: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <Link href="/jobs" className="cb-cat-link cb-intent-link" style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "11px 14px", fontSize: 12, fontWeight: 700, color: "var(--foreground, #111)", textDecoration: "none", whiteSpace: "nowrap", borderBottom: "2px solid transparent", transition: "color 0.15s, border-color 0.15s", flexShrink: 0 }}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/>
              </svg>
              Find Work
            </Link>
            <Link href="/how" className="cb-cat-link" style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "11px 14px", fontSize: 12, fontWeight: 500, color: "var(--text-muted, #6b7280)", textDecoration: "none", whiteSpace: "nowrap", borderBottom: "2px solid transparent", transition: "color 0.15s, border-color 0.15s", flexShrink: 0 }}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
