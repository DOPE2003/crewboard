...
export default function AddEmailForm() {
  ...
  if (done) return (
    <div style={{
      ...
      <span style={{ fontSize: "0.82rem", fontWeight: 600, color: "#166534" }}>Email saved — you'll receive notifications at this address.</span>
    </div>
  );
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: "0.75rem" }}>
        ...
        <div>
          <div style={{ fontWeight: 700, fontSize: "0.88rem", color: "#0f172a" }}>Add your email to receive notifications</div>
